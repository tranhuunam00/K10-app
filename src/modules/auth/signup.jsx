...
const VALIDATE_REPASS = "required|checkPw";
const SignUpScreen = (props) => {
  ...
  const handleChangeInput = (value, validate, name) => {
    ...
    if (name === "password") {
      newListError.confirmPassword = Validate(
        "confirmPassword",
        confirmPassword,
        ParseValid(VALIDATE_REPASS),
        value
      );
    }
  ...
  const handlePressRegister = async () => {
    ...
    if (listError.email || listError.password || listError.confirmPassword) {
      console.log("Error: Vui long nhap cac truong dung dinh dang");
      return NotifyMessage("Error: Vui long nhap cac truong dung dinh dang");
    }
    ...
    <SafeAreaView style={styles.registerViewAll}>
      ...
      <View style={styles.registerView}>
        ...
        <View style={styles.loginFastView}>
          ...
          <View style={styles.loginFast}>
            <Image source={IMAGE_APP.google_ic} style={styles.iconLoginFast} />
          </View>
          <View style={styles.loginFast}>
            <Image source={IMAGE_APP.cib_apple} style={styles.iconLoginFast} />
          </View>
        </View>
